...
رابط برنامه نویسی زبیکس راهی قابل برنامه نویسی جهت انجام تغییرات به صورت گروهی، ایجاد یکپارچگی با برنامه های شخص ثالث و هدف های دیگر فراهم می کند.

### سیستم مجوزها

- احراز هویت ایمن کاربران
- امکان محدود سازی نمای قابل دسترسی کاربران خاص
